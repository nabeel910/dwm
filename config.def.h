...
static const char *fonts[]          = { "Roboto Mono Nerd Font Mono:size=11","Noto Color Emoji:pixelsize=14:antialias=true:autohint=true" };
static const char dmenufont[]       = "Roboto Mono Nerd Font Mono:size=11";
...
static const Rule rules[] = {
	...
	{ "pacman-packages",   		NULL,        NULL,         1 << 8,      	 0,                  -1 },
	{ "Gnomecast",         		NULL,        NULL,         0,      	      	 1,                  -1 }
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4,"-hp", highpriority, NULL };
